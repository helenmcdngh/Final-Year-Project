...
--
create table topic_diagrams(
diagramID char(4) not null,
topicID int not null,
diagramTitle text not null,
diagram blob not null,
primary key(diagramID,topicID),
foreign key (topicID) references topics(topicID)
) Engine = InnoDB;

describe topic_diagrams;
select * from topic_diagrams;

--  ----------------------------------------------------------------------------

-- Subjects added to table
INSERT into subjects values (1,"History");
INSERT into subjects values (2,"Geography");
INSERT into subjects values (3,"Science");

--Topics
--http://www.history.com/topics/industrial-revolution
INSERT into topics values (1000,"Industrial Revolution",
...
Insert into topics values (1001,"World War 2",
...
INSERT into topics values (2000,"Gloabal Warming",
